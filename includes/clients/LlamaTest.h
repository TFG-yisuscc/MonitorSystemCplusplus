...
public:
    LlamaTest(std::string filepath_, std::string model_path, float temperature, int batch_size, int context_size, int seed, int num_prompts, double hardwarePeriod = 0.5);
